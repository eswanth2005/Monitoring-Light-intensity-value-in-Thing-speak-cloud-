...
#define ldr_pin 34
char ssid[] = "xy";   // your network SSID (name) 
...
```
# CIRCUIT DIAGRAM:
![image](https://github.com/user-attachments/assets/53b56e84-6fd8-4a2a-8dc4-96a767efabfe)

# OUTPUT:
![image](https://github.com/user-attachments/assets/068d512a-dcec-4375-9953-1370c65df791)
